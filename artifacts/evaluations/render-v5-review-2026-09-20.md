...
Following review with the user, occasional definitive wording for a supported probable cause is accepted as a disclosed non-blocking limitation for this synthetic demo. The finding remains recorded; no claim of perfect spoken compliance is made. Prompt v5 is retained, and another full live matrix solely for this wording issue is not required. Continue with operational checks and submission assets.
